...
function dw_minion_customize_register( $wp_customize ) {
  ...
  /*********envelope************/
  $wp_customize->add_setting('dw_minion_theme_options[envelope]', array(
  'default'        => '',
  'capability'     => 'edit_theme_options',
  'type'           => 'option',
  ));
  $wp_customize->add_control('envelope', array(
  'label'      => __('envelope', 'dw-minion'),
  'section'    => 'dw_minion_social_links',
  'settings'   => 'dw_minion_theme_options[envelope]',
  ));

  /*********weibo************/
  $wp_customize->add_setting('dw_minion_theme_options[weibo]', array(
  'default'        => '',
  'capability'     => 'edit_theme_options',
  'type'           => 'option',
  ));
  $wp_customize->add_control('weibo', array(
  'label'      => __('weibo', 'dw-minion'),
  'section'    => 'dw_minion_social_links',
  'settings'   => 'dw_minion_theme_options[weibo]',
  ));

  /*********wechat************/
  $wp_customize->add_setting('dw_minion_theme_options[wechat]', array(
  'default'        => '',
  'capability'     => 'edit_theme_options',
  'type'           => 'option',
  ));
  $wp_customize->add_control('wechat', array(
  'label'      => __('wechat', 'dw-minion'),
  'section'    => 'dw_minion_social_links',
  'settings'   => 'dw_minion_theme_options[wechat]',
  ));
