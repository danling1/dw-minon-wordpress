...
function dw_minion_site_actions() {
  ...
  $social_links['envelope'] = dw_minion_get_theme_option( 'envelope', '' );
  $social_links['weibo'] = dw_minion_get_theme_option( 'weibo', '' );
  $social_links['wechat'] = dw_minion_get_theme_option( 'wechat', '' );
  ?>
      ...
      <div class="clearfix actions">
          ...
          <div class="action socials">
              ...
              <?php if(count($social_links) > 0 ) { ?><ul class="unstyled list-socials clearfix" style="width: <?php echo count($social_links)*40; ?>px;">
                  ...
                  <?php if($social_links['envelope']!='') { ?><li class="social"><a href="<?php echo $social_links['envelope']; ?>"><i class="icon-envelope"></i></a></li><?php } ?>
                  <?php if($social_links['weibo']!='') { ?><li class="social"><a href="<?php echo $social_links['weibo']; ?>"><i class="icon-weibo"></i></a></li><?php } ?>
                  <?php if($social_links['wechat']!='') { ?><li class="social"><a href="<?php echo $social_links['wechat']; ?>"><i class="icon-comments"></i></a></li><?php } ?>
              </ul><?php } ?>
          </div>
      </div>
  </div>
